...
HD_PWD='/net/home/ppd/hmo31799/Documents/dune_project/ped_sub/tpg_core/proj/dataflowZCU102/dataflowZCU102/dataflowZCU102.runs/thFMch_input_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log thFMch_input_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source thFMch_input_fifo.tcl
