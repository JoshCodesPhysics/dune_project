...
HD_PWD='/net/home/ppd/hmo31799/Documents/dune_project/ped_sub/tpg_core/proj/dataflowZCU102/dataflowZCU102/dataflowZCU102.runs/crif_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log crif_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source crif_fifo.tcl
