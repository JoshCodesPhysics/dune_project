...
HD_PWD='/net/home/ppd/hmo31799/Documents/dune_project/ped_sub/tpg_core/proj/dataflowZCU102/dataflowZCU102/dataflowZCU102.runs/address_LUT_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log address_LUT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source address_LUT.tcl
