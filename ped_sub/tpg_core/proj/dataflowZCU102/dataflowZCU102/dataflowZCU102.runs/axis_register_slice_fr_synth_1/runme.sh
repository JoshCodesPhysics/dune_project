...
HD_PWD='/net/home/ppd/hmo31799/Documents/dune_project/ped_sub/tpg_core/proj/dataflowZCU102/dataflowZCU102/dataflowZCU102.runs/axis_register_slice_fr_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axis_register_slice_fr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axis_register_slice_fr.tcl
