# ==============================================================
# File generated on Thu Dec 17 13:46:19 GMT 2020
...
if {[file isfile ped_alg.autotvin.dat]} {
	file delete -force ped_alg.autotvin.dat
}

if {[file isfile ped_alg.autotvout.dat]} {
	file delete -force ped_alg.autotvout.dat
}
