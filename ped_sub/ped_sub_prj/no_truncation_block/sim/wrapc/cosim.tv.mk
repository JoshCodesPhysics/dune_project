# ==============================================================
# File generated on Thu Dec 17 13:41:50 GMT 2020
...
AUTOPILOT_ROOT := /opt/ppd/tools/xilinx/Vivado/2018.3
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /opt/ppd/tools/xilinx/Vivado/2018.3/tps/lnx64/gcc-6.2.0/bin
endif
...
$(ObjDir)/pedsub_test2.cpp_pre.cpp.tb.o : pedsub_test2.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling pedsub_test2.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/functions.cpp_pre.cpp.tb.o : functions.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling functions.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
