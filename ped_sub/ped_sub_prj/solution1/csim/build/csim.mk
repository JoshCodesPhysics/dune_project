...
HLS_SOURCES = ../../../../pedsub_test.cpp ../../../../functions.cpp
...
$(ObjDir)/pedsub_test.o: ../../../../pedsub_test.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../pedsub_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/pedsub_test.d
