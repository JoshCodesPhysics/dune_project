...
\begin{abstract}
	The Deep Underground Neutrino Experiment (DUNE) is a large-scale, international project being developed at CERN and will operate within North America. It will consist of two neutrino detectors placed within an intense neutrino beam fired from Fermilab. The main objectives of the project include answering fundamental questions about the origin of matter (CP violation), the unification of forces (proton decay) and the formation of black holes (supernova neutrino detection). This report focusses on the TPG core within the front end of the detectors, specifically the hit finder architecture that will process optical data generated from argon scintillation within the time projection chambers, as a result of neutrino interactions.
\end{abstract}
