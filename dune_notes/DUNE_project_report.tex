...
\begin{itemize}
	\item Chronology effects the operation of HLS blocks unless you use the inbuilt interface systems such as the axis directives
	...
	\item Debugging involves lots of trial and error and beginning with simplistic designs (due to lack of transparency) in contrast to manual HDL debugging.
