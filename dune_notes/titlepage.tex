...
\begin{titlepage}
   \begin{center}
       ...
       \huge
       \textbf{Firmware Implementation for the Proto-DUNE II Hit Finding Architecture with the Xilinx HLS Tool}
       \vspace{0.6cm}
       
       \Large
       \textbf{MPhys project report by Joshua Horswill}
       ...
       \includegraphics[width=51mm]{figures/southampton_crest.jpg}
